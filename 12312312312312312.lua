if game.PlaceId == 6403373529 then 
    ...
    do
        Tabs.Main:AddParagraph({
            Title = "Cosmic Hub is a powerful cheat that can give players a significant advantage in Slap Battles. However, it is important to note that using cheats is unethical and can lead to a ban in the game.",
        ...
        local TeleportDrow = Tabs.Misc:AddDropdown("TeleportSection", {
            Title = "Teleport",
            Values = {"None", "Slapple Island", "Moai Island", "Plate", "Battle Arena", "Cannon Island", "Defualt Arena", "Normal Arena", "Spawn", "Safe Port"},
            Multi = false,
            Default = 1,
        })
...
elseif game.PlaceId == 9431156611 then
    ...
    do
        ...
        local GloveEsp = Tabs.Main:AddToggle("GloveEsp", {Title = "Glove Esp", Default = false })
        ...
        local RemoveSection = Tabs.Badges:AddDropdown("RemoveSection", {
            Title = "Remove",
        ...
        SaveManager:SetIgnoreIndexes({})
        InterfaceManager:SetFolder("FluentScriptHub")
        SaveManager:SetFolder("FluentScriptHub/SlapElude")
        InterfaceManager:BuildInterfaceSection(Tabs.Settings)
        SaveManager:BuildConfigSection(Tabs.Settings)
        Window:SelectTab(1)
    end
